...
export const AnnouncementItem = (props) => {
    return (
        <div className='container-lg'>
            <div className='row b-a-row'>
                <div className='col-lg-3 col-md-3 b-a-banner'>
                    {
                        props.thumbnail ?
