                                            ...
                                            <div className='row'>
                                                <div className='col-lg-6 offset-lg-5'>
                                                    <div className='industry-banner-ebook'>
                                                        ...
                                                        <EBookModal show={show} handleClose={handleClose} src={`https://forms.zohopublic.com.au/corporality/form/CorporalityStrikerEbookNanoTech/formperma/GNrDQycrgM6kkMoGKo0FKCrkeeTI-n6lc6ghhPkMdq8`} />
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div className='container-lg'>
                    ...
                    <div className='row industry-other-industries-row'>
                        ...
                        <OtherIndustryItem
                            ...
                            category={`Age Care and retirement`}
                            slug={`age-care-and-retirement`}
                        />
