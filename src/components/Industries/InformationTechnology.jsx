...
function InformationTechnology() {
    ...
    const category = 'information-technology';
    ...
    const page_slug = 'information-technology';
    ...
    return (
        <div className='industry-page information-technology-page'>
            <Helmet>
                                            ...
                                            <div className='row'>
                                                <div className='col-lg-6 offset-lg-5'>
                                                    <div className='industry-banner-ebook'>
                                                        ...
                                                        <EBookModal show={show} handleClose={handleClose} src={`https://forms.zohopublic.com.au/corporality/form/CorporalityStrikerEbookInfoTech/formperma/1uANeAPXkoVuAHq96ENB0dYJzwl49Amh0N1GA1jIvJI`} />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className='row industry-banner-paper-survey-row'>
                                                <div className='col-md-6'>
                                                    <div className='industry-banner-paper-survey-item industry-banner-paper' style={{ backgroundImage: `url(${API_IMG_URL}pages/${pageDetail.detail.research_paper_image})` }}>
                                                        ...
                                                        <ResearchPaperModal show={show} handleClose={handleClose} src={`https://forms.zohopublic.com.au/corporality/form/ResearchPaperStartReadingInfoTech/formperma/SWFjn9ibsQCSODtiweSwYjAusOcWRRZFRQOWvOPr2fk`} />
                                                    </div>
                                                </div>
