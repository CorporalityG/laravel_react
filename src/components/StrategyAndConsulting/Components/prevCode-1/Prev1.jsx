    ...
    return (
        ...
        <div className="prev-1-Ib">
            ...
            <div className="Out_container_blueprint_yellow">
                <img src = {yellowbackground} className='yellow_IB' alt="STRATEGY AND CONSULTING" />
            </div>
                ...
                <div className="row first-image">
                    <div className="col-lg-6">
                        <div data-aos="fade-right" className="text-box-1">
                            ...
                            <div className="small-rect-prev-1"><img src={smallerrect} alt='smallerrect' className='smaller-rect-prev-1' /></div>
                        </div>
                    </div>
                    <div className="col-lg-6  d-flex justify-content-center text-center flex-column ">
                        <div data-aos="fade-left" className="image-first">
                            <img alt='rect' className='rect' src={rect} />
                            <img alt='wall' className='wall' src={wall} />
                            <img alt='smallrect' className='smallrect' src={smallrect} />
                            <img alt='backimg' className='backimg' src={backimg} />
                            <div className="banner_right_inner" >
                                <img className='main-prev1' src={main} alt="main" />
                            </div>
