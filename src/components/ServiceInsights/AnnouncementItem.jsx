    ...
    return (
        <div className='container-lg'>
            <div className='row si-a-row'>
                <div className='col-lg-3 col-md-3 si-a-banner'>
                    {
                        props.thumbnail ?
