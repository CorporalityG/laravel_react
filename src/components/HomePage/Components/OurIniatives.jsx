              ...
              <div className="col-lg-6 col-md-12 col-sm-12 col-xs-12 mb-xs-20 p-0 our-iniatives-grid">
                <a href={`${pageDetail.initiatives_1_link}`} target={`_blank`} title={`${pageDetail.initiatives_1_title}`}>
                  <figure className="our-iniatives-grid-img-effect">
                    <img src={`${API_IMG_URL}pages/${pageDetail.initiatives_1_image}`} alt={`${pageDetail.initiatives_1_title}`} className="our-iniatives-grid-img" />
                ...
                <div className="row">
                  <div className="col-sm-6 p-0">
                    <a href={`${pageDetail.initiatives_2_link}`} target={`_blank`} title={`${pageDetail.initiatives_2_title}`}>
                      <figure className="our-iniatives-grid-img-effect">
                        <img src={`${API_IMG_URL}pages/${pageDetail.initiatives_2_image}`} alt={`${pageDetail.initiatives_2_title}`} className="our-iniatives-grid-img" />
                        <div className="bottom-gradient-do_more"></div>
                        <figcaption>
                  ...
                  <div className="col-sm-6 p-0">
                    <a href={`${pageDetail.initiatives_3_link}`} target={`_blank`} title={`${pageDetail.initiatives_3_title}`}>
                      <figure className="our-iniatives-grid-img-effect">
                        <img src={`${API_IMG_URL}pages/${pageDetail.initiatives_3_image}`} alt={`${pageDetail.initiatives_3_title}`} className="our-iniatives-grid-img" />
                        <div className="bottom-gradient-do_more"></div>
                        <figcaption>
                  ...
                  <div className="col-sm-6 p-0">
                    <a href={`${pageDetail.initiatives_4_link}`} target={`_blank`} title={`${pageDetail.initiatives_4_title}`}>
                      <figure className="our-iniatives-grid-img-effect">
                        <img src={`${API_IMG_URL}pages/${pageDetail.initiatives_4_image}`} alt={`${pageDetail.initiatives_4_title}`} className="our-iniatives-grid-img" />
                        <div className="bottom-gradient-do_more"></div>
                        <figcaption>
                  ...
                  <div className="col-sm-6 p-0">
                    <a href={`${pageDetail.initiatives_5_link}`} target={`_blank`} title={`${pageDetail.initiatives_5_title}`}>
                      <figure className="our-iniatives-grid-img-effect">
                        <img src={`${API_IMG_URL}pages/${pageDetail.initiatives_5_image}`} alt={`${pageDetail.initiatives_5_title}`} className="our-iniatives-grid-img" />
                        <div className="bottom-gradient-do_more"></div>
                        <figcaption>
