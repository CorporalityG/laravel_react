...
function Articles() {
    ...
    return (
        <div className="articles">
            ...
            <div className="articles-latest-section">
                            ...
                            <>
                                {
                                    latestArticles.slice(0, 1).map((item) =>
                                        <div key={`${item.id}`} className="row latest-article-row">
                                            <div className="col-lg-6 px-lg-0 latest-article-col">
                                            ...
                                            <div className="col-lg-6 pl-lg-0">
                                                <div className="article-banner-first">
                                                    <Link to={`/article/${item.article_slug}`}>
                                                        {item.article_image && <img src={`${API_IMG_URL + item.article_image}`} alt={item.article_title} className="latest-article-img" />}
                                                    </Link>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div className="container-lg">
                    {
                        latestArticles ?
                            <div className="row latest-article-boxes-row">
                                {
            ...
            <div className="articles-constructions-section">
                <div className="container-lg">
                    <div className="row articles-c-title-row">
                            ...
                            <>
                                {
                                    constructionsArticles.slice(0, 1).map((item) =>
                                        <div key={`${item.id}`} className="row articles-c-title-row">
                    ...
                    {
                        constructionsArticles ?
                            <div className="row c-article-boxes-row">
                                {
                                ...
                                <div className="col-lg-3 col-sm-6 latest-article-box-col c-article-col-box">
                                    {
                                        constructionsArticles.slice(4, 6).map((item) =>
                                            <div key={`${item.id}`} className="row c-article-col-row">
                                                ...
                                                <div className="col-lg-8">
                                                    <div className="c-article-col-title">
                                                        <Link to={`/article/${item.article_slug}`}>{item.article_title}</Link>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div className="articles-podcasts-section">
                <div className="container-lg">
                    <div className="row articles-podcasts-title-row">
                        <div className="col-lg-8">
                            <div className="articles-heading">
                                <Link to="/">Podcasts <svg viewBox="0 0 10 16" focusable="false"><path d="m1.83288 15c-.20616 0-.42731-.0737-.58971-.2361-.324226-.3242-.324226-.8402 0-1.1645l5.58722-5.60223-5.58722-5.58722c-.324226-.32422-.324226-.84022 0-1.16445.32422-.324795.84022-.324795 1.16444-.01497l6.17694 6.17694c.1624.1624.23612.36857.23612.58971s-.08869.4273-.23612.58971l-6.17694 6.17691c-.1624.1624-.36857.2361-.57473.2361z" fill="currentColor" stroke="currentColor" strokeWidth=".831256"></path></svg></Link>
                            </div>
                            <div className="articles-p-music">
                                <iframe title="spotify" src="https://open.spotify.com/embed/show/1MaGRx67hlU9lyqPjiSQsK?utm_source=generator" width="100%" height="232" frameBorder="0" allowFullScreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture"></iframe>
                            </div>
                        </div>

                        <div className="col-lg-4 articles-p-col">
                            <div className="articles-p-about">
                                <img src={`${BASE_URL}/img/logo.png`} alt="logo" />
                                <div className='articles-p-about-title'>About</div>
            ...
            <div className="articles-video-section">
                <div className='articles-video-section-bg'></div>
                <div className="container-lg">
                    <div className="row articles-v-title-row">
                        <div className="col-lg-12">
                            <div className="articles-v-title">
                                <Link to="/">Popular Video <svg viewBox="0 0 10 16" focusable="false"><path d="m1.83288 15c-.20616 0-.42731-.0737-.58971-.2361-.324226-.3242-.324226-.8402 0-1.1645l5.58722-5.60223-5.58722-5.58722c-.324226-.32422-.324226-.84022 0-1.16445.32422-.324795.84022-.324795 1.16444-.01497l6.17694 6.17694c.1624.1624.23612.36857.23612.58971s-.08869.4273-.23612.58971l-6.17694 6.17691c-.1624.1624-.36857.2361-.57473.2361z" fill="currentColor" stroke="currentColor" strokeWidth=".831256"></path></svg></Link>
                            </div>
                        </div>
                    </div>

                    <div className="row articles-v-first-row">
                        <div className="col-lg-6">
            ...
            <div className="articles-fintech-section">
                <div className="container-lg">
                    <div className="row articles-fintech-row">
                        <div className='col-lg-9 col-md-8'>
                            ...
                            {
                                finTechArticles ?
                                    <div className='row articles-news-row'>
                                        {
            ...
            <div className="articles-meditech-explore-section">
                <div className="container-lg">
                    <div className="row articles-me-row">
                        <div className='col-lg-6'>
                            <div className="articles-heading">
                        ...
                        <div className="col-lg-3 col-sm-6">
                            <div className="articles-me-subscribe">
                                <img src={`${BASE_URL}/img/logo.png`} alt="logo" />
                                <div className='articles-subscribe-title'>Subscribe for updates</div>
                                <p>A weekly update of what’s on the Corporality Global</p>
                                <div className='articles-mes-form'>
                                    <input type="email" name="emailid" placeholder="Email address" className="emailid" />
                                    <button type="submit" className="articles-mes-btn">
