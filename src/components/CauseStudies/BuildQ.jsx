					...
					<div className="row">
						<div className="col-md-8">
							<div className="case-study-solution-content">
								...
								<img src={BASE_URL + '/img/setting-icon.png'} alt="The solution" className="case-ssc-icon" />
								<h2>The solution</h2>
								...
								<img src={BASE_URL + '/img/write-icon.png'} alt="The outcome" className="case-ssc-icon" />
								<h2>The outcome</h2>
					...
					<div className="row case-study-outcome-content-main">
						<div className="col-md-6">
							<div className="case-study-testimonial">
								<img src={BASE_URL + '/img/Build-Q-logo.png'} alt="Build-Q-logo" className="case-study-testi-logo" />
