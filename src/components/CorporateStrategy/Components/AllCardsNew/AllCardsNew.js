    ...
    <>
      <div className="container">
        ...
        <div className="all_cards_parent">
          ...
          <div className="image_side_2_card4">demo text </div>
          ...
          <div className="image_side_5_card3"> demo text</div>
          <div className="image_side_5_card4"> demo text</div>
          ...
          <div className="image_side_6_card3"> demo text</div>
          <div className="image_side_6_card4"> demo text</div>
        </div>
      </div>
    </>
  );
