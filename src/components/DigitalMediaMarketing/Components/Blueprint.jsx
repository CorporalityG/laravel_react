			...
			<div className="DDMBlueprint mx-5 px-5">
				...
				<section className="blueprint-area">
					<div className="main-blueprint">
						...
						{/* {/main container div/} */}
							{/* <h4 className="blueprint-h4">THE WEBSITE BLUEPRINT MASTER PLAN</h4> */}
