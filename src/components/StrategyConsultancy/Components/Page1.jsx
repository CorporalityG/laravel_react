                ...
                <div className="container">
                    ...
                    <div className="d-md-flex align-items-center justify-content-between consult-pageContent">
                        <div className="consult-page1-content">
                            ...
                            <h1>STRATEGIC GROWTH CONSULTING DRIVEN BY EXPERTISE, ANALYTICS AND EXPERIENCE</h1>
                            ...
                            <div className="consult-page1-img d-sm-flex p-4">
                                <img src={BASE_URL + "/img/StrategyConsultancy/youtubemarketing.png"} alt="youtubemarketing" className=" consultimg2" />
                        ...
                        <div data-aos="fade-left">
                            ...
                            <img className="iluilukyah" src={BASE_URL + "/img/StrategyConsultancy/page-1.png"} alt="page-1" />
                        </div>
                        </div>
                    </div>
