            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <a href="{{ route('industrial-article-categories.create') }}" class="btn btn-sm btn-info float-right">Add Category</a>
                        </div>
                    </div>
                </div>
                    ...
                    <table id="custom-table" class="table table-bordered dataTable yajra-datatable">
                        <thead>
                            <tr>
                                ...
                                <th width="15%">Industrial Articles</th>
...
jQuery(function () {
    var table = $('.yajra-datatable').DataTable({
      processing: true,
      serverSide: true,
      ajax: "{{ route('industrial-article-categories.index') }}",
      columns: [
