...
@section('content')
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <a href="{{ route('team-members.create') }}" class="btn btn-sm btn-info float-right">Add Team Member</a>
                        </div>
                    </div>
                </div>
    ...
    @include('team-members.delete_modal')
