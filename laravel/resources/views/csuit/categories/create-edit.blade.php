	...
	<div class="row">
        <div class="col-md-12">
            ...
            <div class="card card-info">
                ...
                <div class="card-body">
                    @if( !empty($category) )
                        @php $action = route('csuit-categories.update', $category->id); @endphp
                    @else
                        @php $action = route('csuit-categories.store'); @endphp
                    @endif
                    <form method="POST" action="{{ $action }}">
                        ...
                        <a href="{{ route('csuit-categories.index') }}" class="btn btn-default float-right">Back</a>
