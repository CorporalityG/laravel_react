				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							...
							<input type="text" name="research_paper_title" id="research_paper_title" value="{{ old('research_paper_title', $RS_Meta['research_paper_title'] ?? '') }}" class="form-control" placeholder="{{ __('Title') }}">
						</div>
					</div>
                    ...
                    <div class="col-md-12">
						<div class="form-group">
							...
							<input type="text" name="research_paper_subtitle" id="research_paper_subtitle" value="{{ old('research_paper_subtitle', $RS_Meta['research_paper_subtitle'] ?? '') }}" class="form-control" placeholder="{{ __('SubTitle') }}">
						</div>
					</div>
