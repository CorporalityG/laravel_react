...
@section('Title', 'Article Tag List')
...
@section('content')
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <a href="{{ route('article-tags.create') }}" class="btn btn-sm btn-info float-right">Add Tag</a>
                        </div>
                    </div>
                </div>
    ...
    @include('articles.tags.delete_modal')
