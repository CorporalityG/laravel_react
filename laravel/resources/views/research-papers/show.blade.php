...
@section('Title', 'Single Research Paper Detail')
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                            <a href="{{ route('research-papers.edit', $RS_Row->id) }}" class="btn btn-sm btn-secondary">Edit Research Paper</a>
                            <a href="{{ route('research-papers.index') }}" class="btn btn-sm btn-default ml-2">Back</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            @if( !empty($RS_Row->image_file) )
                                <div class="post">
                                    <img src="{{ url('uploads/'.$RS_Row->image_file) }}" alt="{{ $RS_Row->title }}" class="h-100">
                                </div>
                            @endif
                        </div>
                        <div class="col-md-6">
